<?php
// modules/vacancy/VacancyModule.php
...
class VacancyModule {
    ...
    private static function changeStatus(int $vacancyId, string $status, int $byUserId, string $note): array {
        $pdo = getDB();
        $stmt = $pdo->prepare(
    ...
    private static function validateVacancyData(array $data): array {
        $errors = [];
